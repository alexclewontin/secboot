...
func (e *mockHostEnvironmentARM64) SystemVendor() (string, error) {
	return e.systemVendor, nil
}

func (e *mockHostEnvironmentARM64) ProductName() (string, error) {
...
func WithARM64Environment(systemVendor, productName string) MockHostEnvironmentOption {
	return func(env *MockHostEnvironment) {
